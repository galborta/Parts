  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-slate-950 to-slate-900 flex items-center justify-center">
      ...
      >
        ...
        >
          An IFS therapy companion powered by ElevenLabs voice AI
        </motion.p>

        <motion.button
          onClick={handleSignIn}
          className="inline-flex items-center gap-3 px-8 py-4 bg-white text-slate-900 rounded-lg font-semibold text-lg hover:bg-slate-100 transition-colors shadow-lg hover:shadow-xl"
        ...
        >
          <p className="text-sm text-slate-400 mb-4">Built for ElevenHacks #2</p>
